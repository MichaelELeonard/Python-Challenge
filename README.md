...
GOAL
For the Module #3 Challenge we were tasked with creating Python code to handle two potential real-world situations faced by a Banking Institution and a Small Rural Town modernizing its election processes.  
